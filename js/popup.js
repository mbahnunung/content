...
function mrpOpenPopup(inst, settings){
    ...
    var popupUrl = settings.sourcePath + 'popup', pw = settings.popupWidth || player_instance.width(), ph = settings.popupHeight || player_instance.height(), left = (window.screen.width - pw) / 2, top = (window.screen.height - ph) / 2;
